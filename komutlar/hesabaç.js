...
exports.run = async (client, message, args, perms) => {
  ...
  if(hesapdurumu) return message.channel.send(`<:hata:637685816197382165> Bir hesabınız bulunmakta. Geçerli hesabınızın bilgilerini öğrenmek için: \n\`${client.ekoayarlar.botunuzunprefixi}hesabım\``);
